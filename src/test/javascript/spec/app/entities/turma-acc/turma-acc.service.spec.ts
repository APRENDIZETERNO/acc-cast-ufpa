...
describe('Service Tests', () => {
  describe('TurmaACC Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(TurmaACCService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new TurmaACC(0, 'AAAAAAA', 0, currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
        ...
        const returnedFromService = Object.assign(
          {
            ...
            prazoEnvio: currentDate.format(DATE_FORMAT)
          },
          elemDefault
        );
        service
      ...
      it('should create a TurmaACC', () => {
        ...
        const expected = Object.assign(
          {
            inicio: currentDate,
            prazoEnvio: currentDate
          },
          returnedFromService
        );
        service
          .create(new TurmaACC(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
